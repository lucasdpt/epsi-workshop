...
public class AddictionsController {
    ...
    @GetMapping("/my")
    public ResponseEntity<List<UserAddictionModel>> getMyAddictions() throws DataNotFoundException {
        return ResponseEntity.ok(addictionService.getAddictionsForUser());
    }
